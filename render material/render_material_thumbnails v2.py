...
SAMPLES = 32                     # only used if ENGINE == 'CYCLES'
LIGHT_INTENSITY = 1.0            # global multiplier — turn up/down to brighten or dim all lights at once
SUN_ENERGY = 3.0                 # base key light strength (multiplied by LIGHT_INTENSITY)
