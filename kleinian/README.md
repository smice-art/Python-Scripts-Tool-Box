...
load the script in the blender txt environment, than press run and the Kleinian Objects are build. The little script could be a base for a later add-on to build such fractals.
